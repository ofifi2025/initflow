...
with open('/sessions/focused-dazzling-keller/mnt/saas-tob-trackex.html', 'r') as f:
    content = f.read()
...
lines.append("    html += '<div style=\"font-size:13px;font-weight:700;color:#dc2626;margin-bottom:4px\">「' + rName + '」未完成</div>';")
lines.append("    html += '<div style=\"font-size:11px;color:#64748b;margin-bottom:12px\">负责方：' + rDept + ' · 阻塞下游 ' + ds.size + ' 项任务 · 只要它不动，后续全部顺延</div>';")
...
with open('/sessions/focused-dazzling-keller/mnt/saas-tob-trackex.html', 'w') as f:
    f.write(content)
